...
import { Contract, type Ledger, ledger, pureCircuits } from '../managed/privacyloan-credit-scorer/contract/index.js';
import { type PrivacyLoanCreditScorerPrivateState, witnesses } from '../witnesses.js';
...
export class PrivacyLoanCreditScorerSimulator {
  readonly contract: Contract<PrivacyLoanCreditScorerPrivateState>;
  circuitContext: CircuitContext<PrivacyLoanCreditScorerPrivateState>;
  ...
  constructor() {
    ...
    const initialPrivateState: PrivacyLoanCreditScorerPrivateState = createSignedUserProfile(
      0,
      this.providerSk,
      userPubKeyHash,
      this.providerId,
  ...
  public getPrivateState(): PrivacyLoanCreditScorerPrivateState {
