...
import { PrivacyLoanCreditScorerSimulator } from './privacyloan-credit-scorer.simulator.js';
...
describe('PrivacyLoanCreditScorer smart contract', () => {
  ...
  function setAttestedPrivateState(
    simulator: PrivacyLoanCreditScorerSimulator,
    creditScore: bigint,
  ...
  it('generates initial ledger state deterministically', () => {
    const simulator0 = new PrivacyLoanCreditScorerSimulator();
    const simulator1 = new PrivacyLoanCreditScorerSimulator();
  ...
  it('approves a Tier 1 loan and caps at the max amount', () => {
    const simulator = new PrivacyLoanCreditScorerSimulator();
    const userPin = 1234n;
