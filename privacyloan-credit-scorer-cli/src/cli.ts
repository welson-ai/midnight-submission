...
import { type PrivacyLoanCreditScorerProviders, type DeployedPrivacyLoanCreditScorerContract } from './common-types';
...
const deployOrJoin = async (
  providers: PrivacyLoanCreditScorerProviders,
  rli: Interface,
): Promise<DeployedPrivacyLoanCreditScorerContract | null> => {
  while (true) {
...
const changePinFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
...
const blacklistUserFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
...
const removeBlacklistUserFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
...
const rotateAdminFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
...
const registerProviderFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
...
const removeProviderFlow = async (contract: DeployedPrivacyLoanCreditScorerContract, rli: Interface): Promise<void> => {
